...
% Name placeholder
{\bebasneue \Huge \textbf{{John Doe}}} \\
\vspace{1cm}

% Additional text
{\courgette \normalsize in recognition of their invaluable service as a Volunteer. Their significant contributions were instrumental to the success of the 16th Foundation Day celebrations at the IISER, Mohali.} \\
\vspace{1.5cm}
